...
select          Filtering out incomplete gene sequences as predicted by prodigal.
filter_genes    Filter genes according to completeness, length and coverage thresholds [-mincov, -minlen]
